        ...
        <>
            <div className="bg-white shadow-lg rounded-lg lg:p-8 pb-12 mb-8">
                <div className="relative overflow-hidden shadow-md mb-6">
                    <img src={post.featuredImage.url} alt="Post" className="object-top h-80 w-full object-cover  shadow-lg rounded-t-lg lg:rounded-lg" />
                </div>
                <div className="px-4 lg:px-0">
                    <div className="flex items-center mb-8 w-full">
                        ...
                        <div className="font-medium text-gray-700">
                            ...
                            <span className="align-middle font-semibold">{moment(post.createdAt).format('MMM DD, YYYY')}</span>
                        </div>
                    </div>
